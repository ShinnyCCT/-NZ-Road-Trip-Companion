...
export const ITINERARY_DATA: DayItinerary[] = [
  ...
  { 
    ...
    activities: [ 
      { 
          ...
          // Removed lat/lng to disable navigation button
      ...
      { 
        ...
        notes: "市區景點集中，可步行遊覽。",
        subActivities: [
          { title: "基督城植物園", location: "Christchurch Botanic Gardens", lat: -43.5305, lng: 172.6169, notes: "冬天景色普通，夏天有綠葉跟花。" },
          { title: "河岸市場 Riverside Market", location: "Riverside Market", lat: -43.5337, lng: 172.6335, notes: "各國美食室內市集，蜂蜜MGO濃度高且便宜。" },
          { title: "基督城大教堂 & 紙教堂", location: "Christchurch Transitional Cathedral", lat: -43.5309, lng: 172.6370, notes: "附近可看到可愛電車，適合拍照。" },
          { title: "C1 Espresso (早午餐)", location: "C1 Espresso", lat: -43.5345, lng: 172.6385, notes: "郵局改建，漢堡從天花板管線投遞，鹹派不錯。" }
        ]
      },
      { 
        time: "18:00", 
        ...
        notes: "",
        subActivities: [
           { title: "Athens Yacht Club (希臘菜)", location: "Athens Yacht Club", lat: -43.5341, lng: 172.6330, notes: "份量多都很好吃，最推 AYC Flamed Cheese & hot greek doughn。" },
           { title: "Afghan Restaurant (阿富汗菜)", location: "Afghan Restaurant", lat: -43.5285, lng: 172.6390, notes: "份量大又好吃，不用點菜(廚師依人頭出菜 NZD23/人)，排隊多為外帶。", navLink: "https://maps.app.goo.gl/PX4pWZNTfiLEUmWM9" }
        ]
      }
    ] 
  },
  { 
    ...
    activities: [ 
      ...
      { time: "14:00", title: "牧羊人教堂 & 湖畔", type: "visit", duration: "1 hr", location: "Church of the Good Shepherd", lat: -44.0035, lng: 170.4815, notes: "內部不開放，湖畔步道散步，留意魯冰花海。", navLink: "https://maps.app.goo.gl/vnUh9NSfbi46Xsks9" }, 
      { time: "15:30", title: "Mt. John 天文台 & Astro Cafe", type: "visit", duration: "1.5 hr", location: "Mount John Observatory", lat: -43.9859, lng: 170.4644, notes: "喝咖啡眺望蒂卡波湖全景 (需付過路費)。" }, 
      { time: "18:00", title: "Kohan Restaurant (日式)", type: "food", duration: "1.5 hr", location: "Kohan Restaurant", lat: -44.0049, lng: 170.4778, notes: "生鮭魚飯壽司超級好吃，連平日都爆滿，建議預約。" }, 
      { time: "00:45", title: "觀星 (@Mt. John 天文台)", type: "visit", duration: "1.5 hr", location: "Dark Sky Project", lat: -44.0040, lng: 170.4760, notes: "國際暗空保護區，極佳體驗。" } 
    ] 
  },
  { 
    date: "2025-12-03", 
    ...
    activities: [ 
      { 
          ...
          lng: 170.0962, 
          notes: "沿著普卡基湖 (Lake Pukaki) 行駛，風景極美。",
          subActivities: [
              { title: "Mt Cook Alpine Salmon Shop", location: "Mount Cook Alpine Salmon", lat: -44.1442, lng: 170.1168, notes: "鮭魚生魚片，旁邊有普卡基湖 (Lake Pukaki) 可以拍照。", navLink: "https://maps.app.goo.gl/5qL3ajXroGtbZtxq7" }
          ]
      }, 
      { time: "11:15", title: "庫克山冰川健行", type: "activity", duration: "3 hr", location: "Mount Cook Glacier Guiding", lat: -43.7333, lng: 170.0962, notes: "Glacier Hike，需體力。", navLink: "https://maps.app.goo.gl/BmmDL3huPmZaXtL7A" }, 
      { 
          time: "15:00", 
          title: "Hooker Valley 或 Tasman Lake", 
          type: "hike", 
          duration: "2 hr", 
          location: "Hooker Valley Track", 
          lat: -43.7200, 
          lng: 170.1000, 
          notes: "• Hooker Valley Track (庫克山步道)：第一段來回約兩小時，可看到冰川湖 。\n• Tasman Lake Track (塔斯曼湖步道)：推！來回僅需約 40 分鐘，可眺望冰川末端形成的湖泊。" 
      }, 
  ...
  { 
    ...
    activities: [ 
      { time: "09:00", title: "補漏行程 (若 D4 未完成)", type: "hike", duration: "2 hr", location: "Mount Cook Village", lat: -43.7353, lng: 170.0962, notes: "可補走步道。" }, 
      { 
          time: "13:00", 
          title: "移動：前往瓦納卡", 
          type: "transport", 
      ...
      { time: "15:30", title: "Wanaka Lavender Farm (薰衣草)", type: "visit", duration: "1.5 hr", location: "Wanaka Lavender Farm", lat: -44.6862, lng: 169.1756, notes: "12月是薰衣草季，有草泥馬可以餵。" }, 
      { time: "18:00", title: "晚餐", type: "food", duration: "1.5 hr", location: "Wanaka", lat: -44.703181, lng: 169.132098, notes: "", subActivities: [
          { title: "Kai Kikokiko(烤肉)", location: "Kai Whakapai", lat: -44.696068, lng: 169.135213, notes: "外帶的烤肉名店，有牛羊豬。", navLink: "https://maps.app.goo.gl/a59RXhPbxFC73vx67" },
          { title: "Firebird (炸雞)", location: "Firebird Wanaka", lat: -44.694160, lng: 169.124349, notes: "炸雞跟薯條都很好吃。" }
      ] } 
    ] 
  },
  { 
    ...
    activities: [ 
      { time: "10:15", title: "Skydive 跳傘", type: "activity", duration: "3 hr", location: "Skydive Wanaka", lat: -44.7228, lng: 169.2432, notes: "帶著一顆冒險的心，挑戰人生新高度！" }, 
      { time: "13:30", title: "Scroggin Coffee (早午餐)", type: "food", duration: "1 hr", location: "Scroggin Coffee and Eatery", lat: -44.695567, lng: 169.132860, notes: "酸種麵包配炒菇菇。" }, 
      { time: "15:00", title: "Wanaka Lakefront 孤獨樹", type: "visit", duration: "1.5 hr", location: "#ThatWanakaTree", lat: -44.700864, lng: 169.118185, notes: "散步至孤獨樹拍照。" }, 
      { time: "16:30", title: "Patagonia (冰淇淋)", type: "food", duration: "30 min", location: "Patagonia Chocolates Wanaka", lat: -44.695703, lng: 169.131771, notes: "有紐西蘭特有口味 Hokey Pokey。" },
       { time: "18:00", title: "晚餐", type: "food", duration: "1.5 hr", location: "Wanaka", lat: -44.703181, lng: 169.132098, notes: "", subActivities: [
          { title: "Kai Kikokiko(烤肉)", location: "Kai Whakapai", lat: -44.696068, lng: 169.135213, notes: "外帶的烤肉名店，有牛羊豬。", navLink: "https://maps.app.goo.gl/a59RXhPbxFC73vx67" },
          { title: "Firebird (炸雞)", location: "Firebird Wanaka", lat: -44.694160, lng: 169.124349, notes: "炸雞跟薯條都很好吃。" }
      ] } 
  ...
  { 
    ...
    weather: { temp: "18°C", condition: "Sunny", desc: "晴時多雲" }, 
    activities: [ 
      { time: "08:00", title: "Roy’s Peak Track步道", type: "hike", duration: "5-6 hr", location: "Roys Peak Track Car Park", lat: -44.6914, lng: 169.0505, notes: "必去!!景色無敵，5-6小時路程，去偶遇牛牛羊羊吧。" }, 
      ...
      { 
        ...
        notes: "",
        subActivities: [
          { title: "Fergburger 鹿肉漢堡", location: "Fergburger", lat: -45.0318, lng: 168.6588, notes: "隨時排隊，鹿肉漢堡 (Sweet Bambi) 特殊且好吃。" },
          { title: "Himalaya 尼泊爾料理", location: "Himalaya Indian and Nepalese Restaurant", lat: -45.0320, lng: 168.6600, notes: "MOMO 餃子跟炒麵。", navLink: "https://maps.app.goo.gl/TPDRg8czdNyGRk3C6" }
        ]
      } 
    ] 
  },
  { 
    ...
    activities: [ 
      { time: "10:00", title: "Skyline Luge 溜溜車", type: "activity", duration: "2.5 hr", location: "Skyline Queenstown", lat: -45.0274, lng: 168.6526, notes: "纜車上山看風景，必玩 Luge。" }, 
      ...
      { time: "17:00", title: "TSS Earnslaw 蒸汽船 & BBQ", type: "activity", duration: "3.5 hr", location: "RealNZ", lat: -45.0332, lng: 168.6603, notes: "17:00 搭乘蒸汽船遊湖 + 農場 BBQ 晚餐。", navLink: "https://maps.app.goo.gl/DuNGmjVe7LNwN3Ei8" } 
    ] 
  },
  { 
    date: "2025-12-08", 
    ...
    activities: [ 
      ...
      { time: "14:30", title: "Gibbston Valley 酒莊", type: "visit", duration: "1.5 hr", location: "Gibbston Valley Winery", lat: -45.0261, lng: 168.9458, notes: "紅酒莊品酒行程 (Winery)。" }, 
  ...
  { 
    ...
    activities: [ 
      ...
      { time: "13:00", title: "米佛峽灣遊船", type: "activity", duration: "2 hr", location: "Milford Sound Cruise Terminal", lat: -44.6700, lng: 167.9261, notes: "13:00 場次，壯觀峽灣景色。" }, 
      { 
        time: "16:00", 
        title: "移動：返回蒂阿瑙", 
        type: "transport", 
        ...
        subActivities: [
          ...
          { title: "Eglinton Valley", location: "Eglinton Valley", lat: -45.1000, lng: 167.9500, notes: "壯闊的冰川谷草原。" }
       ]
      }, 
      { time: "20:15", title: "Te Anau Glowworm Caves", type: "activity", duration: "2.5 hr", location: "RealNZ Te Anau", lat: -45.4182, lng: 167.7111, notes: "20:15 觀看藍色螢火蟲洞 (需搭船)。" } 
    ] 
  },
  { 
    date: "2025-12-10", 
    ...
    activities: [ 
      ...
      { time: "19:00", title: "Good Good 漢堡", type: "food", duration: "1 hr", location: "Good Good Dunedin", lat: -45.8735, lng: 170.5054, notes: "餐車改建漢堡店 (但尼丁)。" }, 
      { time: "21:00", title: "Blue Penguins Pukekura", type: "activity", duration: "1.5 hr", location: "Blue Penguins Pukekura", lat: -45.8731, lng: 170.7278, notes: "21:00 觀看小藍企鵝歸巢。" } 
    ] 
  },
  { 
    date: "2025-12-11", 
    ...
    activities: [ 
      ...
      { time: "13:30", title: "Riverstone Kitchen 午餐", type: "food", duration: "1 hr", location: "Riverstone Kitchen", lat: -44.9649, lng: 170.9658, notes: "奧瑪魯北邊，使用在地食材。" }, 
      { 
        time: "18:00", 
        title: "晚餐", 
        type: "food", 
        ...
        notes: "",
        subActivities: [
           { title: "Athens Yacht Club (希臘菜)", location: "Athens Yacht Club", lat: -43.5341, lng: 172.6330, notes: "份量多都很好吃，最推 AYC Flamed Cheese & hot greek doughn，Ssganaki超級推。" },
           { title: "Afghan Restaurant (阿富汗菜)", location: "Afghan Restaurant", lat: -43.5285, lng: 172.6390, notes: "份量大又好吃，不用點菜(廚師依人頭出菜 NZD23/人)，排隊多為外帶。", navLink: "https://maps.app.goo.gl/PX4pWZNTfiLEUmWM9" }
        ]
      } 
    ] 
  ...
  { 
    ...
    activities: [ 
      { time: "09:00", title: "基督城市區自由活動", type: "visit", duration: "3 hr", location: "Christchurch Central City", lat: -43.5321, lng: 172.6362, notes: "最後採買或休息。" }, 
      ...
      { time: "16:25", title: "飛往奧克蘭", type: "flight", duration: "1.5 hr", location: "Auckland Airport", lat: -37.0082, lng: 174.7850, notes: "抵達後前往機場飯店。" }, 
      { time: "19:00", title: "入住 Pullman Auckland Airport", type: "rest", duration: "", location: "Teewa Drive, Auckland Airport", lat: -37.0082, lng: 174.7850, notes: "就在機場旁，方便隔天搭機。" } 
    ] 
  },
  { 
    date: "2025-12-13", 
